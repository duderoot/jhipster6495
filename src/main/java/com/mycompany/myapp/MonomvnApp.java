...
public class MonomvnApp {

    private static final Logger log = LoggerFactory.getLogger(MonomvnApp.class);

    private final Environment env;

    public MonomvnApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MonomvnApp.class);
